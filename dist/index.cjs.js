...
var Icon$1o = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 72 120" }, props),
        React__default['default'].createElement("g", { transform: "translate(0.000000,120.000000) scale(0.100000,-0.100000)", fill: "#D92538", stroke: "none" },
            React__default['default'].createElement("path", { d: "M199 986 l3 -205 -98 -120 -99 -120 3 -143 c2 -92 8 -147 15 -155 26\n      -25 331 -233 342 -233 7 0 89 54 184 121 l171 120 0 144 0 144 -117 130 -118\n      130 -3 -219 c-1 -121 -5 -220 -8 -220 -4 0 -115 72 -133 86 -2 2 18 90 43 197\n      25 107 46 200 46 207 0 11 -171 262 -218 320 -16 20 -17 11 -13 -184z" }))));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 260 100" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("linearGradient", { id: "SVGID_1_1", gradientUnits: "userSpaceOnUse", x1: "-0.988", y1: "35.02", x2: "73.6472", y2: "35.02", gradientTransform: "matrix(1 0 0 1 0 2)" },
                React__default['default'].createElement("stop", { offset: "0", stopColor: "#F8C25E" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#E34554" })),
            React__default['default'].createElement("path", { className: "st0", fill: "url(#SVGID_1_1)", d: "M66.9,72.7c-2.8,0-9.3-5.3-3.9-14.1c4.9-7.9,2.6-13.8,2.2-14.8c0,0-0.1-0.1-0.1-0.2c0,0,0,0,0,0l0,0\n          c-1.5-3.1-2.1-6.1-2.4-7.7c-0.1-0.8-0.2-1.2-0.2-1.2c0,0,0,0,0,0c0,0,0,0,0,0s-0.2,0.3-0.3,0.9c-1,3-0.5,5.8,0,7.3\n          c0,0.1,1.3,4.1-2.6,6.6c-1.3,0.7-3,0.9-4.7,0.5c-3.5-1-4.3-4.9-4.3-4.9c-0.3-2.2,0.6-4.2,2.2-5.5l0,0c0.1,0,0.1-0.1,0.2-0.2\n          c6-4.7,4.4-15.7,4.4-15.7s0,0,0,0.2l0-0.2C54.1,34.3,45.6,37,45.6,37c1.5-8.7-4.6-15-4.6-15c-0.9-1.2-2.1-2.3-3.5-3.2\n          c-9.6-6.1-3-17.5-3-17.5s-17.4,11.3-8,22.6l0,0c1.2,1.2,2,2.9,2,4.7c0,3.8-3.2,6.8-7.1,6.8c-3.9,0-7.1-3-7.1-6.8\n          c0-1.8,0.7-3.4,1.9-4.7c0.4-0.3,0.8-0.7,1.2-1c0,0-11.9,5.8-5.6,20.4c4.3,10.1-2.4,20.1-7,25.4c-1.1,1.2-2.8,3-4.2,3.9h5.3l0,0\n          c7.9,0,16.9,0,21,0h2.3h4.8v0H40v0h21.2v0C61.2,72.7,66.9,72.7,66.9,72.7z" }),
            React__default['default'].createElement("linearGradient", { id: "SVGID_2_1", gradientUnits: "userSpaceOnUse", x1: "-0.988", y1: "7.395", x2: "73.6472", y2: "7.395", gradientTransform: "matrix(1 0 0 1 0 2)" },
                React__default['default'].createElement("stop", { offset: "0", stopColor: "#F8C25E" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#E34554" })),
            React__default['default'].createElement("path", { className: "st1", fill: "url(#SVGID_2_1)", d: "M40.9,15.9c-3.2-6.6,2.9-13.1,2.9-13.1C33,8.5,40.9,15.9,40.9,15.9z" }),
            React__default['default'].createElement("linearGradient", { id: "SVGID_3_1", gradientUnits: "userSpaceOnUse", x1: "-0.988", y1: "45.64", x2: "73.6472", y2: "45.64", gradientTransform: "matrix(1 0 0 1 0 2)" },
            ...
            React__default['default'].createElement("path", { className: "st2", fill: "url(#SVGID_3_1)", d: "M1.2,37.7c0,0,5.5,7.9,6.9,19.9C8.1,57.6,12.4,45.7,1.2,37.7z" }),
            React__default['default'].createElement("linearGradient", { id: "SVGID_4_1", gradientUnits: "userSpaceOnUse", x1: "-0.988", y1: "17.85", x2: "73.6472", y2: "17.85", gradientTransform: "matrix(1 0 0 1 0 2)" },
                React__default['default'].createElement("stop", { offset: "0", style: stopColor.stopColor0 }),
                React__default['default'].createElement("stop", { offset: "1", style: stopColor.stopColor1 })),
            React__default['default'].createElement("path", { className: "st3", fill: "url(#SVGID_4_1)", d: "M48.8,27.9c0.3-0.3,3-2.7,2.6-4.8c0,0,1.5,2.7-2.8,7c0,0,7.8-3.9,3.7-10.7c0,0-1.9-2.7-3.7-3.7\n          c-1.8-0.9-2.6-3.4-2.2-6.3c0,0-2.5,4.8,1,10.9C50.6,26,49,27.7,48.8,27.9z" })),
